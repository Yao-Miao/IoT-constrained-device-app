...
class SensorDataGenerator(object):
	...
	LOW_NORMAL_ENV_TEMP = 10
	HI_NORMAL_ENV_TEMP = 30
	MAX_ENV_TEMP = 40.0
	...
	LOW_NORMAL_ENV_HUMIDITY = 20.0
	HI_NORMAL_ENV_HUMIDITY = 70.0
	MAX_ENV_HUMIDITY = 100.0
	
	MIN_SOIL_HUMIDITY = DEFAULT_MIN_VALUE
	LOW_NORMAL_SOIL_HUMIDITY = 20.0
	HI_NORMAL_SOIL_HUMIDITY = 80.0
	MAX_SOIL_HUMIDITY = 100.0
