...
class SprinklerEmulatorTask(BaseActuatorSimTask):
    """
    ...
    def __init__(self):
        ...
        """
        super(SprinklerEmulatorTask, self).__init__(actuatorType = ActuatorData.SPRINKLER_ACTUATOR_TYPE, simpleName = "SPRI")
